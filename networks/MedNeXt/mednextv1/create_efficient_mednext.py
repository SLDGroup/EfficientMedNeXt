...
from networks.MedNeXt.mednextv1.EfficientMedNext import EfficientMedNeXt

from networks.MedNeXt.mednextv1.EfficientMedNext_Full import EfficientMedNeXt_L
